...
APP_TITLE	:=	Twini-Golf
APP_DESCRIPTION	:=	Mini-golf game where you hit 2 balls at once
APP_AUTHOR	:=	PolyMars & LiquidFenrir
...
#---------------------------------------------------------------------------------
all: $(BUILD) $(OUTDIR) $(GFXBUILD) $(DEPSDIR) $(ROMFS_T3XFILES) $(ROMFS_FONTFILES) $(T3XHFILES)
